...
public class ArtistsAdapter extends RecyclerView.Adapter<ArtistsAdapter.ArtistVH> {
    ...
    public class ArtistVH extends RecyclerView.ViewHolder {
        ...
        private class GradientTransformation implements Transformation {
            ...
            public Bitmap transform(Bitmap source) {
                Bitmap bitmap = source.copy(Bitmap.Config.ARGB_8888, true); // Зачем жить, если копируешь битмапы
                Canvas canvas = new Canvas(bitmap);

                // Можно декодировать векторный Drawable, но на preLollipop для этого нужен context. Будем как все
            ...
            @Override
            public String key() {
                return "Yet_another_very_long_key_for_gradient_transformation";
            }
        }
    }
}
